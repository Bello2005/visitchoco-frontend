              ...
              {currentFilter === "indigenous" && selectedReserve ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {selectedMunicipality.description && (
                      <p className="text-gray-600 leading-relaxed">
                        {String(selectedMunicipality.description)}
                      </p>
                    )}
                  </div>
                  ...
                  {weatherData && weatherData.main && (
                    <div className="bg-gradient-to-br from-blue-50/50 to-sky-50/30 p-4 rounded-xl border border-blue-100/20">
                  ...
                  {/* Atracciones principales si existen */}
                  {Array.isArray(selectedMunicipality.attractions) &&
                    selectedMunicipality.attractions.length > 0 && (
                      <div className="space-y-3">
                        <h3 className="text-lg font-semibold text-gray-800 flex items-center gap-2">
                          <span>✨</span> Atracciones principales
                        </h3>
                        <div className="space-y-2">
                          {selectedMunicipality.attractions.map(
                            (attraction, index) => (
                              <div
                                key={index}
                                className="p-3 bg-gray-50/80 rounded-lg border border-gray-100"
                              >
                  ...
                  {selectedMunicipality.transportation && (
                    <div className="space-y-3">
                      <h3 className="text-lg font-semibold text-gray-800 flex items-center gap-2">
                      ...
                      <div className="p-3 bg-gray-50/80 rounded-lg border border-gray-100">
                        <p className="text-gray-700">
                          {String(selectedMunicipality.transportation)}
                        </p>
                      </div>
                    </div>
                  )}
